**A grease monkey script to be able to show the connections on links when using netbox-topology-views (https://github.com/netbox-community/netbox-topology-views)**
